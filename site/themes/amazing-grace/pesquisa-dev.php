...
<?php
include(TEMPLATEPATH . '/pesquisa_functions-dev.php');
...
?>
	<strong>Pesquise nos Ajustes Directos</strong><br />Exemplos: "nome de entidade" | <a href="/?page_id=21&search_str=software">software</a> | <a href="/?page_id=21&search_str=computador">computador</a> | <a href="/?page_id=21&search_str=viatura">viatura</a> | <a href="/?page_id=21&search_str=obra">obra</a>, saiba mais nas <a href="/?page_id=42">Perguntas Frequentes</a> <br />
	<form method="get" id="searchform" action="<?php bloginfo('home'); ?>/?page_id=21">
